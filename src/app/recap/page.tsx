      ...
      <main className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6 flex-1">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 text-xs text-amber-800 space-y-1">
          ...
          <ul className="list-disc list-inside space-y-0.5 text-amber-700">
            <li>Bayar LUNAS sekaligus dalam 1 transaksi: <b>Rp 10.000</b>.</li>
            <li>Jika dicicil dan lunas dalam waktu <b>≤ 1 minggu (7 hari)</b> sejak cicilan pertama: Total bayar <b>Rp 10.000</b>.</li>
            <li>Jika cicilan melebihi <b>1 minggu</b>: Total bayar menjadi <b>Rp 15.000</b>.</li>
          </ul>
        </div>
